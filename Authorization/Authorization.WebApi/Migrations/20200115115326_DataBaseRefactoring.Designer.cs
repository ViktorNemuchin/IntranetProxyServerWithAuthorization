...
namespace Authorization.WebApi.Migrations
{
    ...
    [Migration("20200115115326_DataBaseRefactoring")]
            ...
            modelBuilder.Entity("Db.Authorization.Model.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GroupId = new Guid("a955accf-27ac-4c6b-8023-fee749dc1dd0"),
            ...
            modelBuilder.Entity("Db.Authorization.Model.GroupRight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GroupRightId = new Guid("a955accf-27ac-4c6b-8023-fee749dc1dd0"),
                            GroupId = new Guid("a955accf-27ac-4c6b-8023-fee749dc1dd0"),
                            RightId = new Guid("f2e126d5-fed2-48ca-adaa-2ca51bda1761")
                        });
                });
            ...
            modelBuilder.Entity("Db.Authorization.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("dfdfd02f-8fd3-4032-8121-8dce6b5df257"),
            ...
            modelBuilder.Entity("Db.Authorization.Model.RoleRight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleRightId = new Guid("bbf3a7c3-51f1-40f2-b8c1-14de0bcfc95f"),
                            RightId = new Guid("f2e126d5-fed2-48ca-adaa-2ca51bda1761"),
                            RoleId = new Guid("dfdfd02f-8fd3-4032-8121-8dce6b5df257")
                        });
                });
