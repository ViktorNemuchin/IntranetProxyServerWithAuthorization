...
namespace Authorization.WebApi.Migrations
{
    ...
    [Migration("20191211125117_RemovePassword")]
            ...
            modelBuilder.Entity("Db.Authorization.Model.Group", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GroupId = new Guid("7db660fd-c8f8-45ff-bd16-211ad15e5c85"),
            ...
            modelBuilder.Entity("Db.Authorization.Model.GroupRight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            GroupRightId = new Guid("293280fa-416e-476f-bad4-79b47a0286af"),
                            GroupId = new Guid("7db660fd-c8f8-45ff-bd16-211ad15e5c85"),
                            Module = 0,
                            Object = 0,
                            Operator = 0
            ...
            modelBuilder.Entity("Db.Authorization.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("887d364f-b55e-4149-a1ef-be9f02ad86d6"),
            ...
            modelBuilder.Entity("Db.Authorization.Model.RoleRight", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleRightId = new Guid("993f92bb-c80e-4545-8a84-57fa375eaa58"),
                            Module = 0,
                            Object = 0,
                            Operator = 0,
                            RoleId = new Guid("887d364f-b55e-4149-a1ef-be9f02ad86d6")
